...
> **Info:** Xote re-exports `Signal`, `Computed`, and `Effect` from [rescript-signals](https://github.com/pedrobslisboa/rescript-signals). The API and behavior are provided by that library.
