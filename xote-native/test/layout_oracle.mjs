 ...
 *
 *   node xote-native/test/layout_oracle.mjs           # compare, report, do not write
 *   node xote-native/test/layout_oracle.mjs --write   # also refresh the fixture
 *
...
import { layout } from "../src/host/layout.mjs";
