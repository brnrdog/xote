...
module CounterApp = {
  let component = () => {
    <div className="max-w-2xl mx-auto p-4 md:p-6 space-y-4">
      ...
      // Counter display
      <div className="bg-white dark:bg-stone-800 rounded-2xl border-2 border-stone-200 dark:border-stone-700 p-8 md:p-12 text-center">
      ...
      <div className="flex flex-col sm:flex-row gap-3 justify-center">
        <button
          className="px-6 py-3 md:px-8 bg-stone-900 hover:bg-stone-700 text-white rounded-xl font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-stone-500 focus:ring-offset-2 dark:bg-stone-700 dark:hover:bg-stone-600"
          onClick={decrement}>
          {Component.text("− Decrement")}
        </button>
        <button
          className="px-6 py-3 md:px-8 bg-stone-200 hover:bg-stone-300 text-stone-900 rounded-xl font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-stone-300 focus:ring-offset-2 dark:bg-stone-800 dark:hover:bg-stone-700 dark:text-white"
          onClick={reset}>
