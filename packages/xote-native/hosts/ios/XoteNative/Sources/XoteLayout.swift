...
/// Flexbox layout.
///
/// A line-for-line transliteration of `xote-native/src/host/layout.mjs`, which is
/// checked frame-for-frame against Chromium's own flexbox by
/// `xote-native/test/layout_test.mjs`. Keep the two in step: a change here that is
