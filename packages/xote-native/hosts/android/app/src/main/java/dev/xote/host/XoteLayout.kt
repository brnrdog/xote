 ...
 * Flexbox layout.
 *
 * A line-for-line transliteration of `xote-native/src/host/layout.mjs`, which is checked
 * frame-for-frame against Chromium's own flexbox by
 * `xote-native/test/layout_test.mjs`. **Keep the three in step**: this is now the
 ...
 * nothing tests. `xote-native/conformance/` is what makes that survivable, and
