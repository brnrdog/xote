...
| --- | --- | --- |
| Create 1,000 rows | 76.3 ms | 54.0 ms |
| Replace 1,000 rows | 87.4 ms | 62.6 ms |
| Update every 10th row | 4.2 ms | 9.4 ms |
| Select a row | 0.7 ms | 4.5 ms |
| Swap two rows | 43.1 ms | 51.4 ms |
| Remove a row | 4.0 ms | 7.7 ms |
| Create 10,000 rows | 844 ms | 943 ms |
| Clear 10,000 rows | 176 ms | 106 ms |
| Time to first render | 18.8 ms | 35.0 ms |
| App bundle, gzipped | 7.9 KB | 59.9 KB |
