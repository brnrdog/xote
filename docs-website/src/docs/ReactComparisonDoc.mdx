...
| --- | --- | --- |
| Create 1,000 rows | 58.5 ms | 59.2 ms |
| Replace 1,000 rows | 68.3 ms | 65.6 ms |
| Update every 10th row | 5.5 ms | 9.6 ms |
| Select a row | 0.5 ms | 4.9 ms |
| Swap two rows | 4.9 ms | 58.2 ms |
| Remove a row | 4.4 ms | 8.5 ms |
| Create 10,000 rows | 797 ms | 939 ms |
| Clear 10,000 rows | 79.9 ms | 108 ms |
| Time to first render | 20.5 ms | 43.4 ms |
