...
| --- | --- | --- |
| Create 1,000 rows | 88.7 ms | 62.1 ms |
| Replace 1,000 rows | 93.8 ms | 65.6 ms |
| Update every 10th row | 6.3 ms | 11.7 ms |
| Select a row | 1.0 ms | 5.8 ms |
| Swap two rows | 7.3 ms | 64.8 ms |
| Remove a row | 6.2 ms | 10.6 ms |
| Create 10,000 rows | 919 ms | 947 ms |
| Clear 10,000 rows | 109 ms | 96 ms |
| Time to first render | 24.4 ms | 41.8 ms |
| App bundle, gzipped | 8.4 KB | 59.9 KB |
