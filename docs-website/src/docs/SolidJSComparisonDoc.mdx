...
| --- | --- | --- |
| Create 1,000 rows | 85.5 ms | 60.2 ms |
| Replace 1,000 rows | 120.6 ms | 81.8 ms |
| Update every 10th row | 7.8 ms | 9.6 ms |
| Select a row | 1.1 ms | 0.9 ms |
| Swap two rows | 57.0 ms | 8.0 ms |
| Remove a row | 9.2 ms | 6.0 ms |
| Create 10,000 rows | 961 ms | 629 ms |
| Clear 10,000 rows | 187 ms | 69 ms |
| Time to first render | 23.2 ms | 25.8 ms |
