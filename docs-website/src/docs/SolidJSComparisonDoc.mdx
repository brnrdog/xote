...
| --- | --- | --- |
| Create 1,000 rows | 80.0 ms | 49.8 ms |
| Replace 1,000 rows | 91.6 ms | 62.2 ms |
| Update every 10th row | 5.4 ms | 4.6 ms |
| Select a row | 1.0 ms | 0.7 ms |
| Swap two rows | 5.5 ms | 4.8 ms |
| Remove a row | 5.7 ms | 4.6 ms |
| Create 10,000 rows | 904 ms | 585 ms |
| Clear 10,000 rows | 102 ms | 68 ms |
| Time to first render | 24.5 ms | 19.1 ms |
| App bundle, gzipped | 8.3 KB | 4.7 KB |
