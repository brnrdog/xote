...
| --- | --- | --- |
| Create 1,000 rows | 58.5 ms | 49.9 ms |
| Replace 1,000 rows | 68.3 ms | 59.7 ms |
| Update every 10th row | 5.5 ms | 4.9 ms |
| Select a row | 0.5 ms | 0.7 ms |
| Swap two rows | 4.9 ms | 4.5 ms |
| Remove a row | 4.4 ms | 3.9 ms |
| Create 10,000 rows | 797 ms | 594 ms |
| Clear 10,000 rows | 79.9 ms | 71.8 ms |
| Time to first render | 20.5 ms | 19.1 ms |
