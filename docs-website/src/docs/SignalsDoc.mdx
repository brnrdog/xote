...
> **Info:** Xote re-exports `Signal`, `Computed`, and `Effect` from [rescript-signals](https://brnrdog.github.io/rescript-signals).
...
let app = () => {
  <div>
    ...
    <button onClick={reset}>
      <View.Text value={Prop.static("Reset")} />
    </button>
  </div>
}
...
- [Use the Signals API reference](/docs/api/signals) when you want signatures and quick examples.
