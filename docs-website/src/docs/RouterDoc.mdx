...
let nav = () => {
  <nav>
    <Router.Link to="/" class="nav-link">
      <View.Text value={Prop.static("Home")} />
    </Router.Link>
    <Router.Link to="/docs" class="nav-link">
      <View.Text value={Prop.static("Docs")} />
    </Router.Link>
  </nav>
}
```
...
let nav = () => {
  <nav>
    <Router.Link to="/"> <View.Text value={Prop.static("Home")} /> </Router.Link>
    <Router.Link to="/users"> <View.Text value={Prop.static("Users")} /> </Router.Link>
  </nav>
}
